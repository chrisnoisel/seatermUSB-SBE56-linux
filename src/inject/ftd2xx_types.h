#ifndef FTDXX_TYPES_H
#define FTDXX_TYPES_H
...
extern int pthread_attr_getstack (const pthread_attr_t *__restrict __attr,      void **__restrict __stackaddr,      size_t *__restrict __stacksize)     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2, 3)));
...
extern int pthread_mutexattr_gettype (const pthread_mutexattr_t *__restrict          __attr, int *__restrict __kind)     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
...
extern int pthread_rwlock_init (pthread_rwlock_t *__restrict __rwlock,    const pthread_rwlockattr_t *__restrict    __attr) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
...
extern int pthread_rwlockattr_getpshared (const pthread_rwlockattr_t *       __restrict __attr,       int *__restrict __pshared)     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
...
extern int pthread_rwlockattr_getkind_np (const pthread_rwlockattr_t *       __restrict __attr,       int *__restrict __pref)     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
...
extern int pthread_condattr_getclock (const pthread_condattr_t *          __restrict __attr,          __clockid_t *__restrict __clock_id)     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
...
extern int pthread_barrier_init (pthread_barrier_t *__restrict __barrier,     const pthread_barrierattr_t *__restrict     __attr, unsigned int __count)     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1)));
...
extern int pthread_barrierattr_getpshared (const pthread_barrierattr_t *        __restrict __attr,        int *__restrict __pshared)     __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__nonnull__ (1, 2)));
...
typedef struct _EVENT_HANDLE{    pthread_cond_t eCondVar;
...
enum { FT_OK, FT_INVALID_HANDLE, FT_DEVICE_NOT_FOUND, FT_DEVICE_NOT_OPENED, FT_IO_ERROR, FT_INSUFFICIENT_RESOURCES, FT_INVALID_PARAMETER, FT_INVALID_BAUD_RATE, FT_DEVICE_NOT_OPENED_FOR_ERASE, FT_DEVICE_NOT_OPENED_FOR_WRITE, FT_FAILED_TO_WRITE_DEVICE, FT_EEPROM_READ_FAILED, FT_EEPROM_WRITE_FAILED, FT_EEPROM_ERASE_FAILED, FT_EEPROM_NOT_PRESENT, FT_EEPROM_NOT_PROGRAMMED, FT_INVALID_ARGS, FT_NOT_SUPPORTED, FT_OTHER_ERROR, FT_DEVICE_LIST_NOT_READY,};
typedef void (*PFT_EVENT_HANDLER)(DWORD,DWORD);
typedef ULONG FT_DEVICE;
enum { FT_DEVICE_BM, FT_DEVICE_AM, FT_DEVICE_100AX, FT_DEVICE_UNKNOWN, FT_DEVICE_2232C, FT_DEVICE_232R, FT_DEVICE_2232H, FT_DEVICE_4232H, FT_DEVICE_232H, FT_DEVICE_X_SERIES, FT_DEVICE_4222H_0, FT_DEVICE_4222H_1_2, FT_DEVICE_4222H_3, FT_DEVICE_4222_PROG, FT_DEVICE_900, FT_DEVICE_930, FT_DEVICE_UMFTPD3A,};
typedef struct ft_program_data {  DWORD Signature1;
DWORD Signature2;
DWORD Version;
WORD VendorId;
WORD ProductId;
...
typedef struct ft_eeprom_header {  FT_DEVICE deviceType;
WORD VendorId;
WORD ProductId;
UCHAR SerNumEnable;
WORD MaxPower;
...
typedef struct ft_eeprom_232b {  FT_EEPROM_HEADER common;
} FT_EEPROM_232B, *PFT_EEPROM_232B;
typedef struct ft_eeprom_2232 {  FT_EEPROM_HEADER common;
UCHAR AIsHighCurrent;
UCHAR BIsHighCurrent;
UCHAR AIsFifo;
UCHAR AIsFifoTar;
...
typedef struct ft_eeprom_232r {  FT_EEPROM_HEADER common;
UCHAR IsHighCurrent;
UCHAR UseExtOsc;
UCHAR InvertTXD;
UCHAR InvertRXD;
...
typedef struct ft_eeprom_2232h {  FT_EEPROM_HEADER common;
UCHAR ALSlowSlew;
UCHAR ALSchmittInput;
UCHAR ALDriveCurrent;
UCHAR AHSlowSlew;
...
typedef struct ft_eeprom_4232h {  FT_EEPROM_HEADER common;
UCHAR ASlowSlew;
UCHAR ASchmittInput;
UCHAR ADriveCurrent;
UCHAR BSlowSlew;
...
typedef struct ft_eeprom_232h {  FT_EEPROM_HEADER common;
UCHAR ACSlowSlew;
...
typedef struct ft_eeprom_x_series {  FT_EEPROM_HEADER common;
UCHAR ACSlowSlew;
UCHAR ACSchmittInput;
UCHAR ACDriveCurrent;
UCHAR ADSlowSlew;
...
typedef struct _FTCOMSTAT {  DWORD fCtsHold : 1;
DWORD fDsrHold : 1;
DWORD fRlsdHold : 1;
DWORD fXoffHold : 1;
DWORD fXoffSent : 1;
...
typedef struct _FTDCB {  DWORD DCBlength;
DWORD BaudRate;
DWORD fBinary: 1;
DWORD fParity: 1;
...
typedef struct _FTTIMEOUTS {  DWORD ReadIntervalTimeout;
DWORD ReadTotalTimeoutMultiplier;
DWORD ReadTotalTimeoutConstant;
DWORD WriteTotalTimeoutMultiplier;
DWORD WriteTotalTimeoutConstant;
} FTTIMEOUTS,*LPFTTIMEOUTS;
typedef struct _ft_device_list_info_node {  ULONG Flags;
ULONG Type;
ULONG ID;
DWORD LocId;
